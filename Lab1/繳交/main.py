...
from show_result import show_result, plot_loss_curve, plot_accuracy_curve, plot_loss_and_accuracy_curves
...
def main():
    ...
    parser.add_argument('--epochs', type=int, default=95000, metavar='N',
                        help='number of epochs to train (default: 95000)')
    ...
    activation_layer = {'sigmoid': Sigmoid, 'relu': ReLU}.get(args.activation)
    ...
    loss_history, acc_history = trainer.train(X, y, args.epochs, args.log_interval)

    # --- 結果顯示 ---
    print("\n訓練完成！顯示結果...")
    plot_loss_curve(loss_history)
    plot_loss_and_accuracy_curves(loss_history, acc_history)
    show_result(model, X, y, loss_fn)
